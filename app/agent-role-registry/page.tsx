const page = {
  version: "164.0.0",
  title: "Agent Role Registry Master",
  description: "Defines finance agent roles such as extractor, reviewer, risk checker, evidence builder, and report drafter."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines finance agent roles such as extractor, reviewer, risk checker, evidence builder, and report drafter."
  },
  {
    title: "Engine layer",
