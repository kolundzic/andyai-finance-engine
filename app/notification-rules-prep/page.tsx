const page = {
  version: "189.0.0",
  title: "Notification Rules Prep Master",
  description: "Defines future notification rules for approvals, blockers, follow-ups, and pilot status changes."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines future notification rules for approvals, blockers, follow-ups, and pilot status changes."
  },
  {
