const page = {
  "version": "136.0.0",
  "title": "Assumptions Ledger UI Master",
  "titleSr": "Master UI za registar pretpostavki",
  "purposeEn": "Show assumptions, sources, confidence, risk, review status, and approval state.",
  "purposeSr": "Prikazuje pretpostavke, izvore, sigurnost, rizik, status provere i status odobrenja.",
  "route": "assumptions-ledger-ui"
};
