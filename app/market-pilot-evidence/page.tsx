const page = {
  version: "196.0.0",
  title: "Market Pilot Evidence Master",
  description: "Defines the evidence package needed for serious pilot conversations with partners and clients."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the evidence package needed for serious pilot conversations with partners and clients."
  },
  {
