const page = {
  "version": "142.0.0",
  "title": "Pilot Request Data Model Master",
  "titleSr": "Master model podataka za pilot zahtev",
  "purposeEn": "Define the data model for pilot requests before backend capture.",
  "purposeSr": "Definiše model podataka za pilot zahteve pre backend hvatanja.",
  "route": "pilot-request-data-model"
};
