const page = {
  "version": "143.0.0",
  "title": "Supabase Pilot Capture Prep Master",
  "titleSr": "Master priprema Supabase pilot capture sistema",
  "purposeEn": "Prepare safe Supabase capture boundaries without exposing secrets.",
  "purposeSr": "Priprema sigurne Supabase granice bez izlaganja tajni.",
  "route": "supabase-pilot-capture-prep"
};

const stages = [
  {
    "label": "What this page proves",
    "en": "Prepare safe Supabase capture boundaries without exposing secrets.",
    "sr": "Priprema sigurne Supabase granice bez izlaganja tajni."
  },
  {
