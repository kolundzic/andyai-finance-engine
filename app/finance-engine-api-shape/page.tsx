const page = {
  version: "185.0.0",
  title: "Finance Engine API Shape Master",
  description: "Defines the public shape of future API endpoints without exposing secrets or unsafe production behavior."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the public shape of future API endpoints without exposing secrets or unsafe production behavior."
  },
  {
