const page = {
  version: "168.0.0",
  title: "Operator Dashboard State Master",
  description: "Defines operator dashboard states: pending, blocked, approved, ready, archived."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines operator dashboard states: pending, blocked, approved, ready, archived."
  },
  {
    title: "Engine layer",
