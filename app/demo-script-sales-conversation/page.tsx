const page = {
  "version": "146.0.0",
  "title": "Demo Script / Sales Conversation Master",
  "titleSr": "Master demo skripta i prodajnog razgovora",
  "purposeEn": "Define a clear 15-minute demo and discovery conversation.",
  "purposeSr": "Definiše jasan 15-minutni demo i discovery razgovor.",
  "route": "demo-script-sales-conversation"
};

const stages = [
  {
    "label": "What this page proves",
    "en": "Define a clear 15-minute demo and discovery conversation.",
    "sr": "Definiše jasan 15-minutni demo i discovery razgovor."
  },
  {
