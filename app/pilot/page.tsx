export const metadata = { title: "AndyAI Finance Engine — Request Pilot", description: "AndyAI Finance Engine public proof layer" };
...
export default function Page() {
  return (
    ...
    <section style={{maxWidth:1180,margin:"0 auto",padding:"72px 20px 28px"}}>
      ...
      <h1 style={{fontSize:"clamp(42px,8vw,86px)",lineHeight:0.92,letterSpacing:"-0.08em",margin:"12px 0 18px",maxWidth:1000}}>Bring one finance file or scenario. Review the result before anything moves.</h1>
      <p style={{color:"#cbd5e1",fontSize:20,lineHeight:1.8,maxWidth:920}}>The pilot page now includes visual reassurance so the visitor knows what the output can look like.</p>
    </section>
    <section style={{maxWidth:1180,margin:"0 auto",padding:"20px",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(320px,1fr))",gap:16}}><section style={{border:"1px solid rgba(148,163,184,0.18)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20,display:"grid",gap:14}}>
      <div style={{position:"relative",overflow:"hidden",borderRadius:18,border:"1px solid rgba(148,163,184,0.14)",background:"#0b1120"}}>
        <img src="/demo/sleek-finance-model-dashboard-summary.png" alt="What your output may resemble" style={{display:"block",width:"100%",height:"auto"}} />
      </div>
      <div>
        <h3 style={{margin:"0 0 8px",fontSize:24,letterSpacing:"-0.04em"}}>What your output may resemble</h3>
        <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>A representative example of the kind of structured pack the pilot can produce.</p>
      </div>
    </section>
<section style={{border:"1px solid rgba(148,163,184,0.22)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20}}>
      <h3 style={{marginTop:0,marginBottom:10,fontSize:24,letterSpacing:"-0.04em"}}>Pilot safety promise</h3>
      <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>No payment. No live automation. No database writes. Human review remains included.</p>
    </section>
<section style={{border:"1px solid rgba(148,163,184,0.22)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20}}>
      <h3 style={{marginTop:0,marginBottom:10,fontSize:24,letterSpacing:"-0.04em"}}>Best pilot inputs</h3>
      <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>Founder notes, cash runway scenario, investor update draft, or a messy spreadsheet you want turned into a cleaner model pack.</p>
