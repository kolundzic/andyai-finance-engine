const page = {
  version: "176.0.0",
  title: "Financial Memo Generator Contract Master",
  description: "Defines the contract for client-ready financial memo generation."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the contract for client-ready financial memo generation."
  },
  {
    title: "Engine layer",
