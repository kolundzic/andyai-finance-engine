const page = {
  version: "198.0.0",
  title: "Production Readiness Gap Map Master",
  description: "Defines what remains before real production: database, auth, RBAC, upload parsing, storage, billing, monitoring, and support."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines what remains before real production: database, auth, RBAC, upload parsing, storage, billing, monitoring, and support."
  },
  {
