const page = {
  "version": "150.0.0",
  "title": "Market Pilot Readiness Lock Master",
  "titleSr": "Master zaključavanje tržišne spremnosti za pilot",
  "purposeEn": "Lock the market pilot readiness layer and next roadmap.",
  "purposeSr": "Zaključava sloj tržišne spremnosti za pilot i sledeću mapu."
};

const stages = [
  {
    "label": "What this page proves",
    "en": "Lock the market pilot readiness layer and next roadmap.",
    "sr": "Zaključava sloj tržišne spremnosti za pilot i sledeću mapu."
  },
  {
