const page = {
  "version": "137.0.0",
  "title": "Evidence Pack UI Master",
  "titleSr": "Master UI za paket dokaza",
  "purposeEn": "Show what proof remains after an AI-assisted finance workflow.",
  "purposeSr": "Pokazuje koji dokaz ostaje posle AI finansijskog workflow-a.",
  "route": "evidence-pack-ui"
};
