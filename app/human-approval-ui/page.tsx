const page = {
  "version": "139.0.0",
  "title": "Human Approval UI Master",
  "titleSr": "Master UI za ljudsko odobrenje",
  "purposeEn": "Make the human approval gate visible and understandable.",
  "purposeSr": "Čini kapiju ljudskog odobrenja vidljivom i razumljivom.",
  "route": "human-approval-ui"
};

const stages = [
  {
    "label": "What this page proves",
    "en": "Make the human approval gate visible and understandable.",
    "sr": "Čini kapiju ljudskog odobrenja vidljivom i razumljivom."
  },
  {
