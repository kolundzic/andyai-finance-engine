const page = {
  ...
  description: "Defines the core financial workflow schema: input, task, agent step, review, approval, output."
};
    ...
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <p className="mt-4 max-w-4xl text-lg leading-8 text-slate-400">
          This page is part of the v152-v160 engine schema and architecture road.
          The goal is to define the machine under the product surface.
        </p>
