const page = {
  version: "173.0.0",
  title: "Investor Update Engine Master",
  description: "Defines investor update package generation and approval flow."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines investor update package generation and approval flow."
  },
  {
    title: "Engine layer",
