const page = {
  "version": "145.0.0",
  "title": "Pilot Review Dashboard Master",
  "titleSr": "Master dashboard za pregled pilota",
  "purposeEn": "Create a review dashboard concept for pilot requests.",
  "purposeSr": "Pravi koncept dashboarda za pregled pilot zahteva.",
  "route": "pilot-review-dashboard"
};
