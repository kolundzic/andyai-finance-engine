const page = {
  version: "178.0.0",
  title: "Change Request Loop Master",
  description: "Defines how changes are requested, tracked, resolved, and closed."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how changes are requested, tracked, resolved, and closed."
  },
  {
    title: "Engine layer",
