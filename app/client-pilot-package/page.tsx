const page = {
  "version": "147.1.0",
  "title": "Client Pilot Package Correction Master",
  "titleSr": "Korekcioni master klijentskog pilot paketa",
  "purposeEn": "Correct the incomplete v147.0.0 by adding the real client pilot package route, docs, release note, and TAPFORGE pack.",
  "purposeSr": "Ispravlja nepotpuni v147.0.0 dodavanjem prave client pilot package rute, dokumenata, release note-a i TAPFORGE pack-a."
};

const stages = [
  {
    "label": "What this page proves",
    "en": "Correct the incomplete v147.0.0 by adding the real client pilot package route, docs, release note, and TAPFORGE pack.",
    "sr": "Ispravlja nepotpuni v147.0.0 dodavanjem prave client pilot package rute, dokumenata, release note-a i TAPFORGE pack-a."
  },
  {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <h1 className="max-w-5xl text-4xl font-bold tracking-tight md:text-6xl">{page.title}</h1>
        <p className="mt-4 max-w-5xl text-2xl font-semibold text-cyan-200">{page.titleSr}</p>
        <p className="mt-6 max-w-4xl text-lg leading-8 text-slate-300">{page.purposeEn}</p>
        <p className="mt-4 max-w-4xl text-lg leading-8 text-slate-400">{page.purposeSr}</p>
        ...
        <section className="mt-12 rounded-3xl border border-amber-300/30 bg-amber-300/10 p-6">
          ...
          <p className="mt-3 max-w-4xl leading-7 text-slate-300">
            This route is part of the v147.1-v150 correction road. The goal is to finish market-pilot readiness cleanly.
          </p>
        </section>
