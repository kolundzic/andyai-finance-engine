const page = {
  version: "191.0.0",
  title: "Evaluation Criteria Master",
  description: "Defines how Finance Engine success is measured: clarity, accuracy, time saved, reviewability, evidence quality, and client usefulness."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how Finance Engine success is measured: clarity, accuracy, time saved, reviewability, evidence quality, and client usefulness."
  },
  {
