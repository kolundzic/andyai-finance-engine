const page = {
  version: "195.0.0",
  title: "Excel Comparison Framework Master",
  description: "Defines a fair comparison between Excel and Finance Engine without shallow marketing claims."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines a fair comparison between Excel and Finance Engine without shallow marketing claims."
  },
  {
