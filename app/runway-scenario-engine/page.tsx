const page = {
  version: "172.0.0",
  title: "Runway Scenario Engine Master",
  description: "Defines startup runway scenario logic and review structure."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines startup runway scenario logic and review structure."
  },
  {
    title: "Engine layer",
