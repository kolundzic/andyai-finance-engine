const page = {
  ...
  description: "Locks the pilot operations layer after dashboard, qualification, follow-up, scope, API, storage, access, and notifications."
};

const blocks = [
  {
    title: "Purpose",
    body: "Locks the pilot operations layer after dashboard, qualification, follow-up, scope, API, storage, access, and notifications."
  },
  {
