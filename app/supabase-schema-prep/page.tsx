const page = {
  version: "186.0.0",
  title: "Supabase Schema Prep Master",
  description: "Defines the database preparation layer for pilot requests, workflows, assumptions, evidence, approvals, and audit records."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the database preparation layer for pilot requests, workflows, assumptions, evidence, approvals, and audit records."
  },
  {
