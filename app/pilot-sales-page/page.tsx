const page = {
  "version": "135.0.0",
  "title": "Pilot Sales Page Master",
  "titleSr": "Master stranica za prodaju pilota",
  "purposeEn": "Explain the pilot offer clearly: who it is for, what enters, what comes out, and what stays controlled.",
  "purposeSr": "Jasno objašnjava pilot ponudu: kome služi, šta ulazi, šta izlazi i šta ostaje pod kontrolom.",
  "route": "pilot-sales-page"
};

const stages = [
  {
    "label": "What this page proves",
    "en": "Explain the pilot offer clearly: who it is for, what enters, what comes out, and what stays controlled.",
    "sr": "Jasno objašnjava pilot ponudu: kome služi, šta ulazi, šta izlazi i šta ostaje pod kontrolom."
  },
  {
