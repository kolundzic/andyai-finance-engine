export const metadata = { title: "AndyAI Finance Engine — Visual Value Proof", description: "AndyAI Finance Engine public proof layer" };
...
export default function Page() {
  return (
    ...
    <section style={{maxWidth:1180,margin:"0 auto",padding:"72px 20px 28px"}}>
      <p style={{color:"#facc15",fontWeight:950,letterSpacing:"0.16em",textTransform:"uppercase",fontSize:12}}>Visual proof added</p>
      <h1 style={{fontSize:"clamp(42px,8vw,86px)",lineHeight:0.92,letterSpacing:"-0.08em",margin:"12px 0 18px",maxWidth:1000}}>From messy finance files to a reviewable model pack — now with visual evidence.</h1>
      <p style={{color:"#cbd5e1",fontSize:20,lineHeight:1.8,maxWidth:920}}>These screenshots show the shape of the output: dashboard views, model summaries, approval flow, and before/after transformation story.</p>
    </section>
    <section style={{maxWidth:1180,margin:"0 auto",padding:"20px",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(340px,1fr))",gap:16}}><section style={{border:"1px solid rgba(148,163,184,0.18)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20,display:"grid",gap:14}}>
      <div style={{position:"relative",overflow:"hidden",borderRadius:18,border:"1px solid rgba(148,163,184,0.14)",background:"#0b1120"}}>
        <img src="/demo/saas-finance-engine-dashboard-overview.png" alt="Product overview" style={{display:"block",width:"100%",height:"auto"}} />
      </div>
      <div>
        <h3 style={{margin:"0 0 8px",fontSize:24,letterSpacing:"-0.04em"}}>Product overview</h3>
        <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>A public-facing overview visual showing how the finance engine can present reviewable output in a clean product surface.</p>
      </div>
    </section>
<section style={{border:"1px solid rgba(148,163,184,0.18)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20,display:"grid",gap:14}}>
      <div style={{position:"relative",overflow:"hidden",borderRadius:18,border:"1px solid rgba(148,163,184,0.14)",background:"#0b1120"}}>
        <img src="/demo/sleek-finance-model-dashboard-summary.png" alt="Model summary preview" style={{display:"block",width:"100%",height:"auto"}} />
      </div>
      <div>
        <h3 style={{margin:"0 0 8px",fontSize:24,letterSpacing:"-0.04em"}}>Model summary preview</h3>
        <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>A concise output panel suitable for sample-output and model-preview storytelling.</p>
      </div>
    </section></section><section style={{maxWidth:1180,margin:"0 auto",padding:"20px",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))",gap:16}}><section style={{border:"1px solid rgba(148,163,184,0.22)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20}}>
      <h3 style={{marginTop:0,marginBottom:10,fontSize:24,letterSpacing:"-0.04em"}}>What goes in</h3>
      <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>PDF statements, CSV exports, spreadsheet tabs, founder notes, and scenario assumptions.</p>
    </section>
<section style={{border:"1px solid rgba(148,163,184,0.22)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20}}>
      <h3 style={{marginTop:0,marginBottom:10,fontSize:24,letterSpacing:"-0.04em"}}>What comes out</h3>
      <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>Structured preview dashboards, assumption-ledger style summaries, evidence notes, and approval-ready packs.</p>
    </section>
<section style={{border:"1px solid rgba(148,163,184,0.22)",background:"rgba(15,23,42,0.72)",borderRadius:24,padding:20}}>
      <h3 style={{marginTop:0,marginBottom:10,fontSize:24,letterSpacing:"-0.04em"}}>What stays blocked</h3>
      <p style={{margin:0,color:"#cbd5e1",lineHeight:1.75,fontSize:16}}>Live writes, billing, provider calls, and autonomous execution stay blocked until explicitly enabled later.</p>
