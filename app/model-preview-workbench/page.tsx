const page = {
  "version": "138.0.0",
  "title": "Model Preview Workbench Master",
  "titleSr": "Master radna tabla za pregled modela",
  "purposeEn": "Create a workbench-style view for reviewing financial model previews.",
  "purposeSr": "Pravi radnu površinu za pregled finansijskog modela.",
  "route": "model-preview-workbench"
};
