const page = {
  version: "166.0.0",
  title: "Evidence Linker Master",
  description: "Defines how evidence links assumptions, risks, decisions, and final output."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how evidence links assumptions, risks, decisions, and final output."
  },
  {
    title: "Engine layer",
