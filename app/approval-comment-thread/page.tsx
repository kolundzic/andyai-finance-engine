const page = {
  version: "177.0.0",
  title: "Approval Comment Thread Master",
  description: "Defines structured review comments attached to approval decisions."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines structured review comments attached to approval decisions."
  },
  {
    title: "Engine layer",
