const page = {
  version: "194.0.0",
  title: "User Education Flow Master",
  description: "Defines how users learn the engine through UI, docs, examples, screenshots, diagrams, and later animations."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how users learn the engine through UI, docs, examples, screenshots, diagrams, and later animations."
  },
  {
