const page = {
  version: "181.0.0",
  title: "Pilot Ops Dashboard Master",
  description: "Defines the operational dashboard for tracking pilot users, requests, blockers, approvals, and next actions."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the operational dashboard for tracking pilot users, requests, blockers, approvals, and next actions."
  },
  {
