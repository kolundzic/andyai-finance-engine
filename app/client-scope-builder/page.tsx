const page = {
  version: "184.0.0",
  title: "Client Scope Builder Master",
  description: "Defines how a pilot request becomes a clear project scope with deliverables, assumptions, timeline, and boundaries."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how a pilot request becomes a clear project scope with deliverables, assumptions, timeline, and boundaries."
  },
  {
