const page = {
  version: "182.0.0",
  title: "Pilot Qualification Rules Master",
  description: "Defines criteria for deciding which pilot requests are ready, blocked, too vague, or high value."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines criteria for deciding which pilot requests are ready, blocked, too vague, or high value."
  },
  {
