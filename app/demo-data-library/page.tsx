const page = {
  version: "171.0.0",
  title: "Demo Data Library Master",
  description: "Defines safe realistic demo data without private or client-sensitive information."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines safe realistic demo data without private or client-sensitive information."
  },
  {
    title: "Engine layer",
