const page = {
  version: "197.0.0",
  title: "Partner Demo Pack Master",
  description: "Defines the partner-facing demo package: narrative, route map, proof pages, pilot flow, and next-step CTA."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the partner-facing demo package: narrative, route map, proof pages, pilot flow, and next-step CTA."
  },
  {
