const page = {
  version: "161.0.0",
  title: "Input Normalization Master",
  description: "Defines how messy finance inputs become normalized working objects."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how messy finance inputs become normalized working objects."
  },
  {
    title: "Engine layer",
