const page = {
  ...
  description: "Locks the governed output layer after workflow, evidence, audit, and approval structures."
};

const blocks = [
  {
    title: "Purpose",
    body: "Locks the governed output layer after workflow, evidence, audit, and approval structures."
  },
  {
    title: "Engine layer",
