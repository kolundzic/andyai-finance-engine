const page = {
  version: "175.0.0",
  title: "Forecast Review Engine Master",
  description: "Defines forecast model review and risk explanation workflow."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines forecast model review and risk explanation workflow."
  },
  {
    title: "Engine layer",
