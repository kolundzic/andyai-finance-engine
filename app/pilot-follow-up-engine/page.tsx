const page = {
  version: "183.0.0",
  title: "Pilot Follow-Up Engine Master",
  description: "Defines the follow-up workflow after a pilot request, including next message, evidence request, and demo scheduling."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the follow-up workflow after a pilot request, including next message, evidence request, and demo scheduling."
  },
  {
