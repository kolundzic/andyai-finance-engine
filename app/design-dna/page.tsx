const page = {
  "version": "133.0.0",
  "title": "Design DNA Master",
  "titleSr": "Master vizuelnog DNK standarda",
  "purposeEn": "Formalize the visual and UI standard for the Finance Engine.",
  "purposeSr": "Formalizuje vizuelni i UI standard za Finance Engine.",
  "route": "design-dna"
};
