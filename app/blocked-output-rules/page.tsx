const page = {
  version: "179.0.0",
  title: "Blocked Output Rules Master",
  description: "Defines what the engine must not finalize without human review."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines what the engine must not finalize without human review."
  },
  {
    title: "Engine layer",
