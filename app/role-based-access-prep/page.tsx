const page = {
  version: "188.0.0",
  title: "Role-Based Access Prep Master",
  description: "Defines future access roles: owner, operator, reviewer, client viewer, and admin."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines future access roles: owner, operator, reviewer, client viewer, and admin."
  },
  {
