const page = {
  version: "162.0.0",
  title: "Finance Task Classifier Master",
  description: "Defines how the engine classifies finance tasks before workflow execution."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines how the engine classifies finance tasks before workflow execution."
  },
  {
    title: "Engine layer",
