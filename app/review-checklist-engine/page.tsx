const page = {
  version: "165.0.0",
  title: "Review Checklist Engine Master",
  description: "Defines checklist logic for financial output review."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines checklist logic for financial output review."
  },
  {
    title: "Engine layer",
