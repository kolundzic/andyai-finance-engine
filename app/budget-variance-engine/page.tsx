const page = {
  version: "174.0.0",
  title: "Budget Variance Engine Master",
  description: "Defines plan-vs-actual variance explanation workflow."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines plan-vs-actual variance explanation workflow."
  },
  {
    title: "Engine layer",
