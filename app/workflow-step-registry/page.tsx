const page = {
  version: "163.0.0",
  title: "Workflow Step Registry Master",
  description: "Defines reusable workflow steps for governed finance automation."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines reusable workflow steps for governed finance automation."
  },
  {
    title: "Engine layer",
