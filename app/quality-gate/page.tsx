const page = {
  version: "192.0.0",
  title: "Quality Gate Master",
  description: "Defines quality gates that every client-facing output must pass before handoff."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines quality gates that every client-facing output must pass before handoff."
  },
  {
