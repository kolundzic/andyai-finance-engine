const page = {
  "version": "140.0.0",
  "title": "Frontend Product Clarity Lock Master",
  "titleSr": "Master zaključavanje jasnoće frontenda",
  "purposeEn": "Lock the first product clarity layer for the frontend.",
  "purposeSr": "Zaključava prvi sloj proizvodne jasnoće frontenda.",
  "route": "frontend-clarity-lock"
};
