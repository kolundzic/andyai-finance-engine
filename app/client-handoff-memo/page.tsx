const page = {
  version: "169.0.0",
  title: "Client Handoff Memo Master",
  description: "Defines the client-ready memo structure after a reviewed finance workflow."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines the client-ready memo structure after a reviewed finance workflow."
  },
  {
    title: "Engine layer",
