const page = {
  version: "187.0.0",
  title: "Storage and Privacy Boundary Master",
  description: "Defines what the system may store, what it must not store, and where privacy boundaries must stay visible."
};

const blocks = [
  {
    title: "Purpose",
    body: "Defines what the system may store, what it must not store, and where privacy boundaries must stay visible."
  },
  {
