...
echo "🅰️ AndyAI Finance Engine — Prepare Prefixed Supabase Lab Preview"

OUT="supabase/dry-run-preview/finance-engine-lab-prefixed-preview-v9.8.0.sql"
mkdir -p "$(dirname "$OUT")"
...
echo "🟢 Prefixed SQL preview generated: $OUT"
echo "🟡 Preview ends with ROLLBACK. It is a review artifact, not an apply script."
