#!/usr/bin/env zsh
set -euo pipefail
echo "🅰️ v11.2.0 Executor Input Envelope Verification"
for file in "src/runtime/server-side-read-only-executor-envelope.ts" "docs/runtime/EXECUTOR_INPUT_ENVELOPE_v11.2.0.md" "configs/runtime/executor-input-envelope.v11.2.0.json"; do
